...
model_names = ['msdnet', 'msdnet_overlap', 'msdnet_overlap_imagenet']
...
arch_group.add_argument('--method', type=str, default='overlap') #local_error, no_overlap
arch_group.add_argument('--include_final', default='False', type=str)
arch_group.add_argument('--distillation', default='False', type=str)
arch_group.add_argument('--overlap', type=int, default=3)

#distillation parameters
arch_group.add_argument('--T', type=float, default=1.5)
arch_group.add_argument('--distill_co', type=float, default=0.35)
arch_group.add_argument('--self_distillation', default='False', type=str)
arch_group.add_argument('--num_data', type=int, default=100)
#imagenet
